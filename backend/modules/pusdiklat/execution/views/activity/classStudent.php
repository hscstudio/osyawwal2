...
<div class="training-class-subject-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
			...
			[
				'header' => Yii::t('app', 'BPPK_TEXT_NPP'),
				'vAlign'=>'middle',
				'attribute'=>'number',
				'width'=>'150px',
				'hAlign'=>'center',
		...
		'panel' => [
			...
			'before'=>
				...
				Html::a('<i class="fa fa-fw fa-barcode"></i> Generate NPP',
					Url::to(['generate-npp','id'=>$activity->id,'class_id'=>$class->id]),
					[
						'class'=>'btn btn-default modal-heart pull-right margin-right-small',
						'title'=>'Generate NPP Peserta',
						'modal-title'=>'<i class="fa fa-fw fa-barcode"></i>Generate NPP Peserta',
						'modal-size'=>'modal-lg',
						'data-pjax'=>'0',
						'data-toggle'=>"tooltip",
						'data-placement'=>"top",
