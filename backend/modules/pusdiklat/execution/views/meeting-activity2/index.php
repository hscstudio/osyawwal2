			...
			[
				...
				'value' => function ($data){
					...
					$permit = \hscstudio\heart\helpers\Heart::OrganisationAuthorized(
						[
							'1213030200', // CEK KD_UNIT_ORG 1213020200 IN TABLE ORGANISATION IS SUBBIDANG KURIKULUM
					...
					$object_person=\backend\models\ObjectPerson::find()
						->where([
							'object'=>'activity',
							'object_id'=>$data->id,														
							'type'=>'organisation_1213030200' //1213010100 CEK KD_UNIT_ORG 1213010100 IN TABLE ORGANISATION IS SUBBIDANG KURIKULUM
						])
						->one();
