...
<div class="panel panel-default">
    ...
    <?php $form = ActiveForm::begin([
		'id'=>'form-sptjm',
		'action' => ['sptjm','id'=>$activity->id,'class_id'=>$class->id],
	...
	<?php echo $form->field($model, 'tarif')->textInput(['value'=>'0'])->label('Tarif'); ?>
	<?php echo $form->field($model, 'jamlat')->textInput(['value'=>'0'])->label('Jamlat'); ?>
	...
	<?php
	$this->registerJs("
		$('#form-sptjm').on('beforeSubmit', function(event, jqXHR, settings) {
                var form = $(this);
