...
<div class="activity-index">
		...
		'buttons' => [
			'view' => function ($url, $model) {
						...
						return ($model->status==2)?'':Html::a($icon,['view-student-plan','id'=>$model->id],[
							...
							'modal-title'=>'<i class="fa fa-fw fa-eye"></i>Rencana Sebaran Peserta dari Renbang',
							'modal-size'=>'modal-md',
						]);
					},
		],						
    ...
    <?= GridView::widget([
		...
		'panel' => [
			...
			'before'=>
				Html::a('<i class="fa fa-fw fa-arrow-left"></i> '.Yii::t('app', 'SYSTEM_BUTTON_BACK'), ['index'], ['class' => 'btn btn-warning', 'data-pjax' => '0']).
