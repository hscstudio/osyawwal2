		...
		<div class="letter-assignment-form">
			<?php
				$form = ActiveForm::begin([
					...
					'action'=>[
						'delete-student','id'=>$model->training_id,'student_id'=>$student_id,'training_student_id'=>$model->training_student_id,
					], 
				]);
			?>
            ...
            <div class="row clearfix">
				...
				echo Html::input('text','nama_peserta',$model->trainingStudent->student->person->name,['class'=>'form-control','disabled'=>true,'id'=>'nama_peserta'])
				?>
                </div>               
            </div>
            <div class="row clearfix">
				...
				echo Html::input('text','nip',$model->trainingStudent->student->person->nip,['class'=>'form-control','disabled'=>true,'id'=>'nip'])
				?>
                </div>               
            </div>
            <div class="row clearfix">
            ...
            <tr class="danger">
            	<td align="center"><?php echo $model->trainingClass->class;?></td>
