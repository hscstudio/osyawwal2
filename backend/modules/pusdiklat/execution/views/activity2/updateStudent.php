 ...
 Html::a('<i class="fa fa-fw fa-arrow-left"></i> Back', ['index'], ['class' => 'btn btn-xs btn-primary']) ?>
	...
	<div class="panel-body">
		...
		<div class="form-group">
			<?= Html::submitButton($training_student->isNewRecord ? Yii::t('app', 'SYSTEM_BUTTON_CREATE') : Yii::t('app', 'SYSTEM_BUTTON_UPDATE'), ['class' => $training_student->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
		</div>
