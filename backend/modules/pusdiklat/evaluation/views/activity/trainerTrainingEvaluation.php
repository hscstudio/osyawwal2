...
$this->title = 'Evaluasi Pengajar Diklat';
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'BPPK_TEXT_TRAINING_ACTIVITIES'), 'url' => ['index']];
$this->params['breadcrumbs'][] = 'Evaluasi Pengajar '. Inflector::camel2words($model->name);
?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
				...
				'value' => function ($data) {
					return Html::a('<i class="fa fa-fw fa-download"></i> Rekap',['rekap-execution-evaluation','training_id'=>$data->training_id,'training_class_id'=>$data->id],
						[
							...
							'data-pjax'=>'0',
							'data-toggle' => 'tooltip',
							'title' => ' Unduh Rekap Evaluasi Pengajar',
							'data-container' => 'body'
						]);
				}
			],
			/*[
				...
				'contentOptions'=>['class'=>'kv-sticky-column'],
				'value' => function ($data){
					return Html::a($data->training->student_count_plan,['trainer-execution-evaluation','training_id'=>$data->training_id,'training_class_id'=>$data->id],
						[
