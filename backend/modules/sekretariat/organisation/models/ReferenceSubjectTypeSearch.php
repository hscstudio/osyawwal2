...
/**
 * ReferenceSubjectTypeSearch represents the model behind the search form about `backend\models\Reference`.
 */
class ReferenceSubjectTypeSearch extends Reference
{
    /**
     * @inheritdoc
     */
