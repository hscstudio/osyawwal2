...
/**
 * ReferenceRankClassSearch represents the model behind the search form about `backend\models\Reference`.
 */
class ReferenceRankClassSearch extends Reference
{
    /**
     * @inheritdoc
     */
