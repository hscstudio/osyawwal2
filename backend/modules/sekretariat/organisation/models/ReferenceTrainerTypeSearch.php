...
/**
 * ReferenceTrainerTypeSearch represents the model behind the search form about `backend\models\Reference`.
 */
class ReferenceTrainerTypeSearch extends Reference
{
    /**
     * @inheritdoc
     */
