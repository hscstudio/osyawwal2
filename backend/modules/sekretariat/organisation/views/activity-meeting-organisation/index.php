        ...
        'columns' => [
            ['class' => 'kartik\grid\SerialColumn'],
				...
				[
					...
					$permit = \Yii::$app->user->can('SUBBAGIAN TATALAKSANA');
					$object_person=\backend\models\ObjectPerson::find()
						->where([
							'object'=>'activity',
							'object_id'=>$data->id,														
							'type'=>'organisation_1201020202' //1213010100 CEK KD_UNIT_ORG 1213010100 IN TABLE ORGANISATION IS SUBBIDANG KURIKULUM
						])
						->one();
