...
use backend\modules\sekretariat\organisation\models\ReferenceProgramCodeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceProgramCodeController implements the CRUD actions for Reference model.
 */
class ReferenceProgramCodeController extends Controller
{
    ...
    {
        $searchModel = new ReferenceProgramCodeSearch();
