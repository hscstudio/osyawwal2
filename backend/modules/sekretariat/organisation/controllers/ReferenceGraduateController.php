...
use backend\modules\sekretariat\organisation\models\ReferenceGraduateSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceGraduateController implements the CRUD actions for Reference model.
 */
class ReferenceGraduateController extends Controller
{
    ...
    {
        $searchModel = new ReferenceGraduateSearch();
