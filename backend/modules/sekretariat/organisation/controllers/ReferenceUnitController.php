...
use backend\modules\sekretariat\organisation\models\ReferenceUnitSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceUnitController implements the CRUD actions for Reference model.
 */
class ReferenceUnitController extends Controller
{
    ...
    {
        $searchModel = new ReferenceUnitSearch();
