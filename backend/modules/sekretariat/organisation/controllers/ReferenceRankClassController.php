...
use backend\modules\sekretariat\organisation\models\ReferenceRankClassSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceRankClassController implements the CRUD actions for Reference model.
 */
class ReferenceRankClassController extends Controller
{
    ...
    {
        $searchModel = new ReferenceRankClassSearch();
