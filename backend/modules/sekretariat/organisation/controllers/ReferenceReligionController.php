...
use backend\modules\sekretariat\organisation\models\ReferenceReligionSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceReligionController implements the CRUD actions for Reference model.
 */
class ReferenceReligionController extends Controller
{
    ...
    {
        $searchModel = new ReferenceReligionSearch();
