...
use backend\modules\sekretariat\organisation\models\ReferenceSubjectTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceSubjectTypeController implements the CRUD actions for Reference model.
 */
class ReferenceSubjectTypeController extends Controller
{
    ...
    {
        $searchModel = new ReferenceSubjectTypeSearch();
