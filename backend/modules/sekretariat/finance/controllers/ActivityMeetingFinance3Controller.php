...
use backend\modules\sekretariat\finance\models\ActivityMeetingFinanceSearch;
use backend\modules\sekretariat\finance\models\RoomSearch;
...
/**
 * ActivityMeetingFinanceController implements the CRUD actions for Activity model.
 */
class ActivityMeetingFinance3Controller extends Controller
{
    ...
    public function actionIndex($year='',$status='all')
    {
		...
		$searchModel = new ActivityMeetingFinanceSearch();
		$queryParams = Yii::$app->request->getQueryParams();
		$organisation_id = 26;
		if($status=='all'){
			if($year=='all'){
				$queryParams['ActivityMeetingFinanceSearch']=[
	...
	public function actionPic($id)
    {
		...
		$object_people_array = [
			...
			'organisation_1201030302'=>'PIC Meeting'
		];
