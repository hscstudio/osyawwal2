...
use backend\modules\sekretariat\finance\models\ReferenceSbuSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReferenceSbuController implements the CRUD actions for Reference model.
 */
class ReferenceSbuController extends Controller
{
    ...
    {
        $searchModel = new ReferenceSbuSearch();
