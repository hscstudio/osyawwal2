...
/**
 * ActivityMeetingGeneralController implements the CRUD actions for Activity model.
 */
class ActivityMeetingGeneral2Controller extends Controller
{
	...
	public function actionPic($id)
    {
		...
		$object_people_array = [
			...
			'organisation_1201050101'=>'PIC Meeting'
		];
