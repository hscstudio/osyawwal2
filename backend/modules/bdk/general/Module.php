...
class Module extends \yii\base\Module
{
	...
	public function getMenuItems(){
		...
		if($this->checkAccess([
			...
			$menus_0 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,109,$callback,true);
			if(empty($menus_0)){
				$menus_0 = [
		...
		if($this->checkAccess([
			...
			$menus_1 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,110,$callback,true);
			if(empty($menus_1)){
				$menus_1 = [
		...
		if($this->checkAccess([
			...
			$menus_2 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,111,$callback,true);
			if(empty($menus_2)){
				$menus_2 = [
		...
		if($this->checkAccess([
			...
			$menus_3 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,112,$callback,true);
			if(empty($menus_3)){
				$menus_3 = [
