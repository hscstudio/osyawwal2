	...
	<div class="panel-body">
		<div class="letter-assignment-form">
            ...
            <div class="row clearfix">
				...
				echo Html::input('text','jabatan_ttd_dua','Kepala Seksi Evaluasi dan Informasi',['class'=>'form-control','id'=>'jabatan_ttd_dua']);
				?>
                </div>
            </div>  
            <div class="row clearfix">
				...
				echo Html::input('text','nama_ttd_dua',Person::findOne(['id'=>Employee::findOne(['satker_id'=>Yii::$app->user->identity->employee->satker_id,'organisation_id'=>'347','chairman'=>'1'])->person_id])->name,['class'=>'form-control','id'=>'ttd_dua']);
				?>
                </div>
            </div>    
            <div class="row clearfix">
				...
				echo Html::input('text','nip_ttd_dua',Person::findOne(['id'=>Employee::findOne(['satker_id'=>Yii::$app->user->identity->employee->satker_id,'organisation_id'=>'347','chairman'=>'1'])->person_id])->nip,['class'=>'form-control','id'=>'nip_ttd_dua']);
				?>
                </div>
            </div>
            <div class="row clearfix">
