...
class Module extends \yii\base\Module
{
	...
	public function getMenuItems(){
		...
		if($this->checkAccess([
			...
			$menus_1 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,126,$callback,true);
			if(empty($menus_1)){
				$menus_1 = [
					['icon'=>'fa fa-fw fa-book', 'label' => 'Training Activity', 'url' => ['activity/index'],'path'=>[
						'/activity/',
					]],
					['icon'=>'fa fa-fw fa-briefcase', 'label' => 'Meeting Activity', 'url' => ['meeting-activity/index'],'path'=>[
						'/meeting-activity/',
					]],
				];
			}
		...
		if($this->checkAccess([
			...
			$menus_2 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,127,$callback,true);
			if(empty($menus_2)){
				$menus_2 = [
		...
		if($this->checkAccess([
			...
			$menus_3 = \mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id,128,$callback,true);
			if(empty($menus_3)){
				$menus_3 = [
