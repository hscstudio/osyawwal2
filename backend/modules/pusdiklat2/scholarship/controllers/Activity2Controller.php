...
use backend\modules\pusdiklat2\scholarship\models\TrainingActivitySearch;
...
class Activity2Controller extends Controller
{
    ...
    public function actionPic($id)
    {
		...
		$renders['model'] = $model;
		$object_people_array = [
			//1213010200 CEK KD_UNIT_ORG 1213010200 IN TABLE ORGANISATION
			'organisation_1202010201'=>'PIC TRAINING ACTIVITY [SUBBAG KEUANGAN]'
		];
    ...
    public function actionExportTraining($year='',$status='nocancel',$filetype='xlsx')
    {
		...
		$template = Yii::getAlias('@file').DIRECTORY_SEPARATOR.'template'.DIRECTORY_SEPARATOR.'pusdiklat'.
			DIRECTORY_SEPARATOR.'general'.DIRECTORY_SEPARATOR.'training.list.'.$filetype;
