...
use backend\modules\pusdiklat2\general\models\MeetingActivitySearch;
...
class MeetingActivity2Controller extends Controller
{
    ...
    public function actionPic($id)
    {
		...
		$renders['model'] = $model;
		$object_people_array = [
			// CEK ID 1213010200 IN TABLE ORGANISATION
			'organisation_1213010200'=>'PIC Meeting'
		];
