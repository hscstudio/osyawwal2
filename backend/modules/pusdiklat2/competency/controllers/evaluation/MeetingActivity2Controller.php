...
use backend\modules\pusdiklat2\competency\models\evaluation\MeetingActivitySearch;
...
class MeetingActivity2Controller extends Controller
{
    ...
    public function actionPic($id)
    {
		...
		$renders['model'] = $model;
		$object_people_array = [
			// CEK ID 1213030200 IN TABLE ORGANISATION
			'organisation_1213040200'=>'PIC MEETING'
		];
    ...
    public function actionExportMeeting($year='',$status='all',$filetype='xlsx')
    {
		...
		$template = Yii::getAlias('@file').DIRECTORY_SEPARATOR.'template'.DIRECTORY_SEPARATOR.'pusdiklat'.
			DIRECTORY_SEPARATOR.'evaluation'.DIRECTORY_SEPARATOR.'meeting.list.'.$filetype;
